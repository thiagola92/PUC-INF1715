define void @main() {
  ...
  %label2 = alloca float
  %label3 = alloca float
  store float 10.500000, float* %label1
  store float 20.500000, float* %label2
